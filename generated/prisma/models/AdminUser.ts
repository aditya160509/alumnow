...
export type AdminUserWhereInput = {
  ...
  permissions?: Prisma.StringFilter<"AdminUser"> | string
...
export type AdminUserScalarWhereWithAggregatesInput = {
  ...
  permissions?: Prisma.StringWithAggregatesFilter<"AdminUser"> | string
}
...
export type AdminUserOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "permissions", ExtArgs["result"]["adminUser"]>
...
export interface AdminUserDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const adminUserWithUserIdOnly = await prisma.adminUser.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AdminUsers and only return the `userId`
   * const adminUserWithUserIdOnly = await prisma.adminUser.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more AdminUsers and only return the `userId`
   * const adminUserWithUserIdOnly = await prisma.adminUser.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
